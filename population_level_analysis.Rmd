...
### Min year for each variable

```{r}

minyrs <- function(data, var){
  x <- data %>%
...
bind_rows(min_years, .id = "variable")

```
### Partition Data - 5y Increments

Working backwards from 2023, with final increment (2019-2023) being 4 years.
