...
new_10plus_stations$STATION_ID -> f

f %in% unique(data$STATION_ID)
f %in% unique(solids_data$STATION_ID)
f %in% unique(N_data$STATION_ID)
f %in% unique(tss_data$STATION_ID)
